...
const insertFunctional = (tableName, columnValuePairs) => `INSERT INTO ${tableName} (${Object.keys(columnValuePairs)}) VALUES (${Object.values(columnValuePairs).map((elm)=>typeof(elm) == 'string' ? `'${elm}'` : elm)})`
